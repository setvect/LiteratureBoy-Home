...
FCKConfig.ToolbarSets["Default"] = [
	['Source','DocProps','-','Preview', '-','Cut','Copy','Paste','PasteText','PasteWord','-','Print','SpellCheck', 'Undo','Redo','-','Find','Replace','-','SelectAll','RemoveFormat'],
	'/',
	['Bold','Italic','Underline','StrikeThrough','-','Subscript','Superscript','Link','Unlink','Anchor','-'],['JustifyLeft','JustifyCenter','JustifyRight','JustifyFull'],
	'/',
...
FCKConfig.FontNames		= '±º∏≤; ±√º≠; µ∏øÚ; πŸ≈¡; Arial;Comic Sans MS;Courier New;Tahoma;Times New Roman;Verdana' ;
